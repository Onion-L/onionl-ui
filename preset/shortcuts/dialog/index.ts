...
export const dialogShortcuts: Shortcut[] = [
  ...
  ['ol-dialog__container', 'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-screen max-w-screen opacity-100 transition-all duration-300 flex flex-col items-center justify-center rounded-md overflow-hidden origin-top-left'],
