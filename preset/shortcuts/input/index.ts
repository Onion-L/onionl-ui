...
export const inputShortcuts: Shortcut[] = [
  ['ol-input', 'w-60 h-4 px-2 py-3 border-2 text-base rounded-lg border-solid border-gray-400 bg-white transition-all duration-200 ease-in-out focus:outline-none focus:ring-1 focus:border-primary placeholder-gray-400 shadow-sm hover:shadow-md'],
