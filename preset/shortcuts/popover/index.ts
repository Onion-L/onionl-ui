...
export const popoverShortcuts: Shortcut[] = [
  ...
  ['ol-popover__content', 'text-popover-text bg-popover p-y-2 p-x-4 border border-solid border-1 border-popover-border rounded-md shadow-md whitespace-nowrap'],
